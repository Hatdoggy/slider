...
const Slider= (props)=>{
    ...
    return <div className="flx flx-col flx-jc-ce flx-ai-ce w-100">
        ...
        <span className="flx w-100">
            <small className="aleg aleg-blck">{currency}{bound.mini}</small>
            <small className="aleg aleg-blck m-l-auto">{currency}{bound.maxi}</small>
        </span>
    </div>
}
...
const Slide = (props)=>{
    ...
    return <section className="prog pos-rel flx flx-col flx-jc-sa flx-ai-ce w-100 bg-wht h-70 p-20 m-t-5">
        <p className="aleg aleg-reg">{slider.head}</p>
        <h2 className="aleg aleg-blck txt-grn">{currency}{val}</h2>
